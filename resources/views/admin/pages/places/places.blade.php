...
<main class="content">
    <div class="container-fluid p-0">
        ...
        <h1 class="h3 mb-3"><strong>Places</strong></h1>
                    ...
                    <table class="table table-responsive table-hover my-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('admin.places.edit',$v['id'])}}" class="text-warning">Edit</a> | <a href="{{route('admin.places.destroy',$v['id'])}}" class="text-danger" onclick="return confirm('Are you sure to delete?')">Delete</a>
                                </td>
                            </tr>
                            @empty
                            <tr>
