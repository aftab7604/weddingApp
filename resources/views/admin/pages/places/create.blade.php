...
<main class="content">
    <div class="container-fluid p-0">
        ...
        <h1 class="h3 mb-3"><strong>Places</strong> Create</h1>
                ...
                <div class="card flex-fill">
                    <div class="card-header">
                        <h5 class="card-title mb-0">
                            <a href="{{route('admin.places')}}" class="btn btn-success">Back</a>
                        </h5>
                            ...
                            <div class="col-12">
                                ...
                                <form action="{{route('admin.places.store')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group mt-2">
                                        ...
                                        <textarea id="location" name="location" autocomplete="off" class="form-control" placeholder="Enter location here"></textarea>
