                    ...
                    <table class="table table-responsive table-hover my-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('admin.products.edit',$v['id'])}}" class="text-warning">Edit</a> | <a href="{{route('admin.products.destroy',$v['id'])}}" class="text-danger" onclick="return confirm('Are you sure to delete?')">Delete</a>
                                </td>
                            </tr>
                            @empty
                            <tr>
